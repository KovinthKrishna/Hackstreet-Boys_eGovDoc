...
export default function TravelWarrantForm() {
  ...
  const handleSubmitRequest = async () => {
    ...
    try {
      ...
      requestFormData.append(
        "DependantChildName",
        formData.dependantChildren || "None",
      );
      requestFormData.append(
        "DependantChildAge",
        formData.childrenAges ? parseInt(formData.childrenAges) : 0,
      );
          ...
          <div className="space-y-5 pb-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg border-0 bg-white/30 px-4 py-3 text-black backdrop-blur-sm focus:ring-2 focus:ring-indigo-500 focus:outline-none"
              >
